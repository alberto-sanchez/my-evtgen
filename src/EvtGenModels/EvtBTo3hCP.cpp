...
EvtBTo3hCP::EvtBTo3hCP()
    : pi(3.141592653), Mass_rho(0.770), Gam_rho(0.150), M_B(5.2794),
      M_pip(0.13957), M_pim(0.13957), M_pi0(0.134976), M_Kp(0.49368),
      Mass_Kstarp(0.8916), Mass_Kstar0(0.8961), Gam_Kstarp(0.0498),
      Gam_Kstar0(0.0505), factor_max(1) {}
...
int EvtBTo3hCP::compute3piMPP(EvtVector4R &p1, EvtVector4R &p2, EvtVector4R &p3,
...
int EvtBTo3hCP::compute3piP00(EvtVector4R &p1, EvtVector4R &p2, EvtVector4R &p3,
                              double &real_B0, double &imag_B0,
                              double &real_B0bar, double &imag_B0bar,
                              int iset) {
  int ierr = 0;
...
int EvtBTo3hCP::computeKpipi(EvtVector4R &p1, EvtVector4R &p2, EvtVector4R &p3,
  ...
  double W12 =
      1. / ((square(Mass_Kstar0 - m12) + square(Gam_Kstar0 / 2.)) * m12);
  double W13 =
      1. / ((square(Mass_Kstarp - m13) + square(Gam_Kstarp / 2.)) * m13);
  double W23 = 1. / ((square(Mass_rho - m23) + square(Gam_rho / 2.)) * m23);
...
EvtComplex EvtBTo3hCP::EvtCRhoF_W(double s) {
  ...
  if (kuhn_santa) {
    result =
        (EvtcBW_KS(s, square(AmRho), GamRho) +                //!...BW-rho( 770)
    ...
    result = (EvtcBW_GS(s, square(AmRho), GamRho) +
              EvtcBW_GS(s, square(AmRhoP), GamRhoP) *
                  (beta)+EvtcBW_GS(s, square(AmRhoPP), GamRhoPP) * (gamma)) /
             (1. + beta + gamma);
  }
  return result;
}
