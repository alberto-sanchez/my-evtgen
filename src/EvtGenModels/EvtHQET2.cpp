...
void EvtHQET2::init(){
  ...
  if ( d1type==EvtSpinType::SCALAR) {
    ...
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "HQET2 model for scalar meson daughters needs 2 arguments. Sorry."<<endl;
    ::abort();
  }  
  }
    ...
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "HQET2 model for vector meson daughtersneeds 4 arguments. Sorry."<<endl;
    ::abort();
    }
  }
  else{
